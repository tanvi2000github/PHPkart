...
<div class="container-fluid Hfill"> <!-- CONTAINER -->
  ...
  <div class="row-fluid Hfill general_menu_container">
	...
	?>
      <script type="text/javascript" src="<?php echo abs_plugins_path;?>/businesstype/admin/retail_discount_calc.js"></script>
    <?php
	 }
	?>
  <?php
  ...
  ?>
      <script type="text/javascript" src="<?php echo abs_plugins_path;?>/dgoods/admin/dgoods_admin_script.js"></script>
    <?php
   }
