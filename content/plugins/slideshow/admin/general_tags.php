...
$page_title = $lang_['pl_slideshow']['FLEX_MAIN_MENU_TITLE'];/*--> Page Title of this platform part */
$icon_menu = 'icon-picture';/*--> Icon used for menu and table title */
$box_title = '<i class="'.$icon_menu.'"></i> '.$lang_['pl_slideshow']['FLEX_TABLE_TITLE']; /*--> Table title */
$table_name = $table_prefix."slideshow"; /*--> the database table where you want work */
...
$menu_title = $lang_['pl_slideshow']['FLEX_MAIN_MENU_TITLE']; /*--> Menu title for this section */
$breadcrumb = '<ul class="breadcrumb">
				...
				<li class="active">
				  <i class="'.$icon_menu.'"></i> '.$lang_['pl_slideshow']['FLEX_MAIN_MENU_TITLE'].'
				</li>
               </ul>';
?>