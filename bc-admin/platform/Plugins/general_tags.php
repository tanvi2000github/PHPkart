...
$page_title = $lang_['plugins']['FLEX_MAIN_MENU_TITLE'];/*--> Page Title of this platform part */
$icon_menu = 'icon icon-gear';/*--> Icon used for menu and table title */
$box_title = '<i class="icon icon-black '.$icon_menu.'"></i> '.$lang_['plugins']['FLEX_TABLE_TITLE']; /*--> Table title */
$table_name = $table_prefix."plugins"; /*--> the database table where you want work */
...
$menu_title = $lang_['plugins']['FLEX_MAIN_MENU_TITLE']; /*--> Menu title for this section */
$breadcrumb = '<ul class="breadcrumb">
				...
				<li class="active">
				  <i class="icon icon-gray '.$icon_menu.'"></i> '.$lang_['plugins']['FLEX_MAIN_MENU_TITLE'].'
				</li>
               </ul>';
?>