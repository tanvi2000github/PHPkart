...
$page_title = $lang_['pl_multitax']['FLEX_MAIN_MENU_TITLE'];/*--> Page Title of this platform part */
$icon_menu = 'icon-list-alt';/*--> Icon used for menu and table title */
$box_title = '<i class="'.$icon_menu.'"></i> '.$lang_['pl_multitax']['FLEX_TABLE_TITLE']; /*--> Table title */
$table_name = $table_prefix."taxes"; /*--> the database table where you want work */
...
$menu_title = $lang_['pl_multitax']['FLEX_MAIN_MENU_TITLE']; /*--> Menu title for this section */
$breadcrumb = '<ul class="breadcrumb">
				...
				<li class="active">
				  <i class="icon-gray '.$icon_menu.'"></i> '.$lang_['pl_multitax']['FLEX_MAIN_MENU_TITLE'].'
				</li>
               </ul>';
?>